...
export default class Navigation {
    ...
    setView() {
         ...
         * Methods
         */
        this.view.down = (_x: number, _y: number) => {
            this.view.drag.previous.x = _x;
            this.view.drag.previous.y = _y;
        };

        this.view.move = (_x: number, _y: number) => {
        ...
        this.view.zoomIn = (_delta: number) => {
         ...
         * Mouse events
         */
        this.view.onMouseDown = (_event: Event) => {
        ...
        this.view.onMouseMove = (_event: Event) => {
            _event.preventDefault();

            this.view.move(_event.clientX, _event.clientY);
        };

        this.view.onMouseUp = (_event: Event) => {
            _event.preventDefault();
         ...
         * Touch events
         */
        this.view.onTouchStart = (_event: Event) => {
            _event.preventDefault();
        ...
        this.view.onTouchMove = (_event: Event) => {
            _event.preventDefault();
        ...
        this.view.onTouchEnd = (_event: Event) => {
            _event.preventDefault();
         ...
         * Context menu
         */
        this.view.onContextMenu = (_event: Event) => {
            _event.preventDefault();
        };
         ...
         * Wheel
         */
        this.view.onWheel = (_event: Event) => {
            _event.preventDefault();
    ...
    update() {
        ...
        if (this.view.drag.alternative) {
            ...
            right.applyQuaternion(
                this.camera.modes.default.instance.quaternion
            );
